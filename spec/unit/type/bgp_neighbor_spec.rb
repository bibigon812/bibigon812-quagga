...
describe Puppet::Type.type(:bgp_neighbor) do
  ...
  describe 'when validating values' do
    describe 'ensure' do
      ...
      it 'should support absent as a value' do
        expect { described_class.new(:name => '192.168.1.1', :ensure => :activate) }.to_not raise_error
      end

      it 'should support absent as a value' do
        expect { described_class.new(:name => '192.168.1.1', :ensure => :shutdown) }.to_not raise_error
      end
  ...
  describe 'name' do
    ...
    it 'should not support 10.256.0.0 as a value' do
      expect { described_class.new(:name => '10.256.0.0') }.to raise_error(Puppet::Error, /Invalid value/)
    end
  end
  ...
  describe 'default_originate' do
    it 'should support \'true\' as a value' do
      expect { described_class.new(:name => '192.168.1.1', :default_originate => 'true') }.to_not raise_error
    end
    ...
    it 'should support \'false\' as a value' do
      expect { described_class.new(:name => '192.168.1.1', :default_originate => 'false') }.to_not raise_error
    end
    ...
    it 'should support \'enabled\' as a value' do
      expect { described_class.new(:name => '192.168.1.1', :default_originate => 'enabled') }.to_not raise_error
    end
    ...
    it 'should support \'disabled\' as a value' do
      expect { described_class.new(:name => '192.168.1.1', :default_originate => 'disabled') }.to_not raise_error
    end
    ...
    it 'should not support allow as a value' do
      expect { described_class.new(:name => '192.168.1.1', :default_originate => 'allow') }.to raise_error(Puppet::Error, /Invalid value/)
    end

    it 'should contain enabled' do
      expect(described_class.new(:name => '192.168.1.1', :default_originate => 'true')[:default_originate]).to eq(:enabled)
    end

    it 'should contain enabled' do
      expect(described_class.new(:name => '192.168.1.1', :default_originate => 'enabled')[:default_originate]).to eq(:enabled)
    end
    ...
    it 'should contain disabled' do
      expect(described_class.new(:name => '192.168.1.1', :default_originate => 'false')[:default_originate]).to eq(:disabled)
    end

    it 'should contain disabled' do
      expect(described_class.new(:name => '192.168.1.1', :default_originate => 'disabled')[:default_originate]).to eq(:disabled)
    end
  ...
  describe 'peer_group' do
    ...
    it 'should support \'enabled\' as a value' do
      expect { described_class.new(:name => '192.168.1.1', :peer_group => 'enabled') }.to_not raise_error
    end
    ...
    it 'should support \'disabled\' as a value' do
      expect { described_class.new(:name => '192.168.1.1', :peer_group => 'disabled') }.to_not raise_error
    end
    ...
    it 'should contain enabled' do
      expect(described_class.new(:name => '192.168.1.1', :peer_group => 'true')[:peer_group]).to eq(:enabled)
    end

    it 'should contain enabled' do
      expect(described_class.new(:name => '192.168.1.1', :peer_group => 'enabled')[:peer_group]).to eq(:enabled)
    end
    ...
    it 'should contain disabled' do
      expect(described_class.new(:name => '192.168.1.1', :peer_group => 'false')[:peer_group]).to eq(:disabled)
    end

    it 'should contain disabled' do
      expect(described_class.new(:name => '192.168.1.1', :peer_group => 'disabled')[:peer_group]).to eq(:disabled)
    end
  ...
  describe 'local_as' do
    it 'should support 100 as a value' do
      expect { described_class.new(:name => '192.168.1.1', :local_as => '100') }.to_not raise_error
    end
    ...
    it 'should not support 0 as a value' do
      expect { described_class.new(:name => '192.168.1.1', :local_as => 0) }.to raise_error(Puppet::Error, /Invalid value/)
    end

    it 'should not support AS100 as a value' do
      expect { described_class.new(:name => '192.168.1.1', :local_as => 'AS100') }.to raise_error(Puppet::Error, /Invalid value/)
    end

    it 'should contain 100' do
      expect(described_class.new(:name => '192.168.1.1', :local_as => '100')[:local_as]).to eq(100)
    end
  ...
  describe 'remote_as' do
    it 'should support 100 as a value' do
      expect { described_class.new(:name => '192.168.1.1', :remote_as => '100') }.to_not raise_error
    end
    ...
    it 'should not support 0 as a value' do
      expect { described_class.new(:name => '192.168.1.1', :remote_as => 0) }.to raise_error(Puppet::Error, /Invalid value/)
    end

    it 'should not support AS100 as a value' do
      expect { described_class.new(:name => '192.168.1.1', :remote_as => 'AS100') }.to raise_error(Puppet::Error, /Invalid value/)
    end

    it 'should contain 100' do
      expect(described_class.new(:name => '192.168.1.1', :remote_as => '100')[:remote_as]).to eq(100)
    end
